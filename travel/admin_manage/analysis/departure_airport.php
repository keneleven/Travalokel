...
<html>
    ...
    <body>
        <?php
            ...
            $arrData = array(
                "chart" => array(
                    "caption"=> "Number of airport usage on departure trip",
            ...
            */
            $strQuery = "SELECT DISTINCT a.codeName, COUNT(l.airportIDStart) as AirportCount from legs l INNER JOIN airport a ON l.airportIDStart = a.airportID 
     GROUP BY a.airportID LIMIT 10";
