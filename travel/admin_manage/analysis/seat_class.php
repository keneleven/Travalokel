...
<?php
    ...
    $strQuery = "SELECT SUM(seatAmount) AS SeatAmount, classType FROM class GROUP BY classType ORDER BY SUM(seatAmount) DESC LIMIT 10";
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "bgcolor" => "FFFFFF",
              "caption" => "Amount of seat per class",
