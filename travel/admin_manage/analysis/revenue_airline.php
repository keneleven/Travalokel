...
<?php
    ...
    $strQuery = "SELECT SUM(totalAmount) AS Revenue, al.airlineName from payment_and_bill pb 
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "Revenue of airline on each month",
                        "paletteColors" => "#4682b4,#6C2DC7,#800517,#348017,#4E387E",
               "bgColor" => "#ffffff",
              "borderAlpha"=> "20",
              "canvasBorderAlpha"=> "0",
