...
<html>
    ...
    <body>
        <?php
            ...
            $arrData = array(
                "chart" => array(
                    "caption"=> "Number of airport usage on landing trip",
            ...
            */
            $strQuery = "SELECT DISTINCT a.codeName, COUNT(l.airportIDDest) as AirportCount from legs l INNER JOIN airport a ON l.airportIDDest = a.airportID 
