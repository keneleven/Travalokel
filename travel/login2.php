						...
						<div class="row">
							<div class="col-sm-5 col-md-5">
								...
								<div class="tabulation animate-box">
								   ...
								   <!-- Tab panes -->
                                    ...
                                    <form method="POST" action="/travel/login.php">
									 	...
									 	<div class="row">
                                            ...
                                            <div class="col-xxs-12 col-xs-6 mt">
												<section>
                                                    ...
                                                    <a href="register.html" class="btn btn-primary2 btn-block">Sign Up</a>
												</section>
											</div>
                                            <div class="col-xxs-12 col-xs-6 mt">
												<section>
                                            <a href="index.html">Fotgot your password</a>
												</section>
											</div>
										</div>
									 </div>
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h2>Welcome</h2>
									<h3>to awesome flight bokking online</h3>
